        ...
        <div class="flex flex-col items-center">
            <div class="w-9/10 p-6 m-auto">
                            ...
                            <table class="table border-separate border-spacing-x-2 w-full">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <Link :href="route('categories.show', {id: product.category_id})" class="btn btn-info text-white">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ formatCurrency(cheapest) }} <span v-if="expenses > cheapest"> ~ {{ formatCurrency(expenses) }} </span></td>
                                    </tr>
                                    <tr>
                ...
                <div tabindex="0" class="collapse collapse-arrow bg-base-100 border-base-300 border">
                    ...
                    <div class="collapse-title font-semibold">Daftar Varian Barang</div>
                        ...
                        <template v-for="variant in product.variants" :key="variant.id">
                            <div class="box-content w-full border md:box-border bg-white shadow-lg shadow-gray-sm p-2">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <th class="size-4xl font-semibold opacity-60">Merk/Jenis</th>
                                            <td>{{ variant.merk }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th class="size-4xl font-semibold opacity-60">Dimensi</th>
                                            <td>{{ variant.dimension }}</td>
                                        </tr>
                                        <tr>
                                            <th class="size-4xl font-semibold opacity-60">Stok</th>
