...
import { Check, OctagonAlert, Pencil, Trash } from 'lucide-vue-next';
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-2 pb-8" v-if="categories.data.length > 0">
            <div class="flex justify-between mx-6 mt-2 mb-6" >
                ...
                <div>
                    ...
                    <Button
                        class="bg-teal-400 hover:shadow-lg hover:shadow-teal-100 hover:bg-teal-500 cursor-pointer">Kategori
            ...
            <div 
                ...
                <div v-for="category in categories.data" :key="category.id" v-bind="$attrs" 
                    ...
                    <div class="relative">
                        <div
                            ...
                            <a href="#" @click.prevent="handleModal" :data-url="`/categories/${category.id}/delete`"  class="relative inline-block group">
